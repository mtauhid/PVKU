              ...
              <div class='row box box-transparent'>
                <div class='col-xs-6 col-sm-2'>
                  <div class='box-quick-link blue-background'>
                    <a href="<?php echo base_url('mobile/c_alternatif')?>">
                      <div class='header'>
                        <div class='icon-comments'></div>
                      </div>
                      <div class='content'>Alternatif</div>
                    </a>
                  </div>
                </div>
                <div class='col-xs-6 col-sm-2'>
                  <div class='box-quick-link green-background'>
                    <a href='<?php echo base_url('mobile/c_kriteria/')?>'>
                      <div class='header'>
                        <div class='icon-star'></div>
                      </div>
                      <div class='content'>Kriteria</div>
                    </a>
                  </div>
                </div>
                <div class='col-xs-6 col-sm-2'>
                  <div class='box-quick-link orange-background'>
                    <a href='<?php echo base_url('mobile/c_pembobotan/')?>'>
                      <div class='header'>
                        <div class='icon-magic'></div>
                      </div>
                      <div class='content'>Pembobotan</div>
                    </a>
                  </div>
                </div>
                <div class='col-xs-6 col-sm-2'>
                  <div class='box-quick-link purple-background'>
                    <a href='<?php echo base_url('mobile/c_perhitungan/')?>'>
                      <div class='header'>
                        <div class='icon-eye-open'></div>
                      </div>
                      <div class='content'>Perhitungan</div>
                    </a>
                  </div>
                </div>
              </div>
