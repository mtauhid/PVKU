                  ...
                  <div class='box'>
                    ...
                    <div class='row'>
                      <div class='col-sm-6'>
                          ...
                          <?php
                        foreach($data_pembobotan as $row){
                        ?>
                        <a href="<?php base_url('')?>edit_pembobotan/<?php echo $row->id_bobot?>" style="text-decoration: none;">
                        <div class='box-content box-statistic'>
                          
                          <h3 class='title text-success'><?php echo $row->nama_kriteria?></h3>
                          <small style="font-weight: bold;">Bobot Awal : <?php echo $row->skala_kriteria." (".$row->bobot_awal.")"?></small><br>
                          <small style="font-weight: bold;">Bobot Akhir : <?php echo number_format($row->bobot_akhir, 5)?></small>
