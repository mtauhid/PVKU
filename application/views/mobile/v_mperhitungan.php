                  ...
                  <div class='box'>
                    ...
                    <div class='row'>
                      <div class='col-sm-6'>
                        ...
                        ?>
                        <a href="<?php base_url('')?>c_alternatif/edit_alternatif/<?php echo $row->id_alternatif?>" style="text-decoration: none;">
                        <div class='box-content box-statistic'>
                          
                          <h3 class='title text-success'><?php echo $row->nama_alternatif?></h3>
                          <small>Vektor S : <?php echo $row->vektor_s?></small><br>
                          <small> Vektor V : <?php echo $row->vektor_v?></small>
