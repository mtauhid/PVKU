<script src="<?php echo base_url('')?>assets/js/jquery.js"></script>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Nilai Alternatif <b><?php echo $data_alternatif->nama_alternatif?></b></h4>
                  ...
                  <form id="form1" class="forms-sample" method="post">
                    ...
                    <div class="form-group">
                      <label for="exampleInputName1">Kandungan Protein</label>
                      <input type="hidden" name="id_alternatif_4" class="form-control" id="exampleInputName1" value="<?php echo $this->uri->segment(3)?>" readonly>
                      <input type="hidden" name="id_kriteria_4" class="form-control" id="exampleInputName1" value="4" readonly>
                      <input type="text" name="nilai_4" class="form-control" id="exampleInputName1" required>
                    </div>
