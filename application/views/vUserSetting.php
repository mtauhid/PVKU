                ...
                <div class="card-body">
                  ...
                  <form id="form1" class="forms-sample" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="level" class="form-control" id="exampleInputName1" value="<?php echo $data_user->level?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <a class="btn btn-light" href="<?php echo site_url('Dashboard')?>">Batal</a>
                  </form>
                </div>
              </div>
            </div>
